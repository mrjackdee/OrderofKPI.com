        ...
        <div className="bg-white border border-gold/30 rounded-[28px] p-6 md:p-8 shadow-soft backdrop-blur-md relative overflow-hidden">
          ...
          <div className="mt-6 pt-4 border-t border-gold/10 text-center">
            <a 
              ...
              className="inline-flex items-center gap-2 text-xs font-bold text-ivy hover:text-gold transition-colors bg-gold/10 px-4 py-2 rounded-xl border border-gold/20"
            >
