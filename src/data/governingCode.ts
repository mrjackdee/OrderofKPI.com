...
export const CONSTITUTION_DATA: Article[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "Section 3", text: "All prospective candidates will fill out and return a written application to the organization, which will be scored by the Membership Committee, and must obtain a score of 80 and above in order to be offered an interview for possible selection to participate in the Membership Intake Process. After interviews of prospective candidates have been conducted, the candidates must be properly voted on, by financial members only, and they must obtain half of the financial member votes plus one in order to be offered selection to be a part of the Membership Intake Process." },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "Section 7", text: "Elections should follow the procedures prescribed in the “The Light”. The members of the Directorate shall be elected by a plurality vote at the monthly organization meeting." }
    ]
  },
  {
    id: "Article IX",
    ...
    sections: [
      ...
      { id: "Section 2", text: "Communication, Publicity, and Public Relations: Disseminates information about the organization and organization programs, approve all releases and advertisements for the organization." },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "Section 2", text: "Any modifications or changes to “The Light” must be submitted at the organization meeting before the meeting it will be voted upon to ensure appropriate understanding and question time." },
...
export const BYLAWS_DATA: Article[] = [
  ...
  },
  {
    ...
    sections: [
      { id: "Section 1", text: "Jurisdiction: The Directorate of Officers will consist of the composition as outlined in Art II. Sec. 2. Each region shall encompass one geographic area in accordance with Art 5, Sec. 2. The organization shall maintain the arrangement and composition of such a Directorate as membership numbers shall allow and sustain." },
  ...
  },
  {
    ...
    sections: [
      { id: "Section 1", text: "Regional Demarcation: There will be a total of five Regions identified as follows: a. Northeastern Region, b. Southeastern Region, c. Midwest Region, d. Gulf Region, e. Western Region." },
      { id: "Section 2", text: "Regions: Each Region shall comprise of one (1) regional division until further amendment of these Bylaws." },
      { id: "Section 3", text: "[Reserved]." },
      { id: "Section 4", text: "Conditions of Continual Function: Regions must abide by these Bylaws, the purpose as designated in the Articles of Incorporation, and the local, state, and federal laws in any place where Region members reside and shall conduct business." },
      { id: "Section 5", text: "Decommissioning: Decommissioning of Regions shall occur when there are no financially active members in the region and this lack persists for a period of three (3) Organizational years, or following a finding for cause of decommissioning due to misconduct, abuse, or illegal/illicit activities." }
    ]
  },
  {
    id: "Article VI",
