...
export async function getLiveGoogleSheetRoster(): Promise<GoogleSheetRosterResponse> {
  ...
  return {
    ...
    members: [
      ...
      { firstName: "Sammie", lastName: "Poe", fullName: "Sammie Poe", fy26Paid: true, fy27Paid: true, mipCert: true, personalEmail: "sammie.poe@gmail.com", phone: "", kpiEmail: "sammie.poe@orderofkpi.org", notes: "", fy27MipEligible: true, isDeanVoterEligible: true, isEligibleVoter: true },
      ...
      { firstName: "Kevin", lastName: "Jennings", fullName: "Kevin Jennings", fy26Paid: true, fy27Paid: true, mipCert: true, personalEmail: "kevin.jennings@gmail.com", phone: "", kpiEmail: "kevin.jennings@orderofkpi.org", notes: "", fy27MipEligible: true, isDeanVoterEligible: true, isEligibleVoter: true },
