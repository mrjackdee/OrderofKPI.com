...
const events: EventItem[] = [
  ...
  { step: 11, title: 'Makeup Interviews', date: '8/24/2026', time: '', category: 'Interviews & Review', icon: UserCheck },
  { step: 12, title: 'Interview Video Review', date: '8/21/2026 - 8/26/2026', time: '', category: 'Interviews & Review', icon: Video },
  { step: 13, title: 'MIP Voting Period', date: '8/26/2026 - 8/28/2026', time: '', category: 'Voting & Next Steps', icon: ThumbsUp },
  { step: 14, title: 'Candidate Notifications', date: '8/28/2026', time: '', category: 'Voting & Next Steps', icon: Star },
  { step: 15, title: 'No Contact Period Begins', date: '8/31/2026', time: '', category: 'Voting & Next Steps', icon: Hand },
  { step: 16, title: 'First Initiation Payment Due', date: '9/11/2026', time: '', category: 'Voting & Next Steps', icon: Wallet },
];

const deanEvents: EventItem[] = [
  { step: 1, title: 'Chapter Notification & Nominations Open', date: '8/7/2026', time: '', icon: Mail },
  { step: 2, title: 'Dean Nominations Accepted', date: '8/10/2026 - 8/12/2026', time: '', icon: Edit3 },
  { step: 3, title: 'Special Meeting', date: '8/16/2026', time: '7:00 PM ET', icon: Users },
  { step: 4, title: 'Dean Team Voting', date: '8/17/2026 - 8/19/2026', time: '', icon: ThumbsUp },
  { step: 5, title: 'Announcement of Dean', date: '8/20/2026', time: '', icon: Star },
  { step: 6, title: 'Dean Selects Assistant Dean & Team', date: '8/24/2026 - 8/26/2026', time: '', icon: UserCheck },
  { step: 7, title: 'Dean Team Announcement', date: '8/28/2026', time: '', icon: Shield },
  { step: 8, title: 'Dean Process Begins', date: '8/31/2026', time: '', icon: Flag },
];
