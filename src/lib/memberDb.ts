...
export const defaultMembers: MemberUser[] = [
  ...
  { name: "Edward Cook", email: "edward.cook@orderofkpi.org", role: "officer", title: "Epistoleus", committees: ['judicial_ethics'], committeeRoles: { judicial_ethics: 'member' } },
  ...
  { name: "Keith Woods", email: "keith.woods@orderofkpi.org", role: "member", committees: ['annual_event'], committeeRoles: { annual_event: 'member' } },
  { name: "Sammie Poe", email: "sammie.poe@orderofkpi.org", role: "member", committees: ['annual_event'], committeeRoles: { annual_event: 'member' } },
  { name: "Donald Mitchell", email: "donald.mitchell@orderofkpi.org", role: "member", committees: ['judicial_ethics'], committeeRoles: { judicial_ethics: 'member' } },
  { name: "Dominic Goodman", email: "dominic.goodman@orderofkpi.org", role: "member", committees: ['scholarship'], committeeRoles: { scholarship: 'member' } },
  { name: "Denzel Talley", email: "denzel.talley@orderofkpi.org", role: "member", committees: ['scholarship'], committeeRoles: { scholarship: 'member' } },
  { name: "Alejandro Araujo", email: "alejandro.araujo@orderofkpi.org", role: "member", committees: ['digital_technology'], committeeRoles: { digital_technology: 'member' } },
  { name: "Demetrist Thomas", email: "demetrist.thomas@orderofkpi.org", role: "member", committees: ['transfer_member'], committeeRoles: { transfer_member: 'member' } },
  { name: "Kameron Whitfield", email: "kameron.whitfield@orderofkpi.org", role: "member", committees: ['digital_technology'], committeeRoles: { digital_technology: 'member' } },
  { name: "Kevin Jennings", email: "kevin.jennings@orderofkpi.org", role: "member" },
  { name: "Tobias Bordley", email: "tobias.bordley@orderofkpi.org", role: "member", committees: ['transfer_member'], committeeRoles: { transfer_member: 'member' } },
...
export function getVisibleCommitteesForUser(user: {
  ...
  const norm = normalizeUserRBAC(user);
  const isSuperChair = norm.title === 'Super Committee Chair';
  const is1stAnti = is1stAntiBasileus(user) || is1stAntiBasileus(norm);
  const isExecutive = norm.role === 'admin' || norm.role === 'officer' || isSuperChair || is1stAnti;
