...
export default function Agenda() {
  ...
  return (
    <motion.div 
      ...
      className="max-w-4xl mx-auto px-4 py-12 flex flex-col items-center relative"
    >
      <FloatingParticles />
      ...
      <motion.div variants={itemVariants} className="mt-12 md:mt-16 relative z-10 w-full flex justify-center">
        <MotionLink 
          whileHover={{ 
            scale: 1.05, 
            y: -5, 
